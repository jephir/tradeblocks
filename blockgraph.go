...
// SwapAddressAccountID returns the account and ID of a swap address
func SwapAddressAccountID(address string) (account string, id string) {
...
// OrderAddressAccountID returns the account and ID of an order  address
func OrderAddressAccountID(address string) (account string, id string) {
	s := strings.Split(address, ":")
	return s[0] + ":" + s[1], s[3]
}
